  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href=" {{ route('admin.product') }} " class="sl-menu-link @yield('product')">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="chart-flot.html" class="nav-link  @yield('manage_product')">Manage Product</a></li>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('backend') }}/img/img7.jpg" class="wd-32 rounded-circle" alt="">
            </a>
