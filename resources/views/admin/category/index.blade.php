                  ...
                  @foreach ($categories as $category)
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="{{ url('admin/categories/delete/'.$category->id) }}" class="btn btn-sm btn-danger" onclick="return confirm( 'Are you sure you want to delete?' )" >Delete</a>
                          @if($category->status == 1)
                          <a href="{{ url('admin/categories/status/'.$category->id) }}" class="btn btn-sm btn-danger">Inactive</a>
                          @else
                          <a href="{{ url('admin/categories/status/'.$category->id) }}" class="btn btn-sm btn-success">Active</a>
                          @endif
                      </td>
                    </tr>
                    @endforeach
